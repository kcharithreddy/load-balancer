...
def decrypt_text(ciphertext: str) -> str:
    """
    Reverses encrypt_text(). Returns ciphertext as fallback if the
    ciphertext was unreadable or encrypted with an old key, ensuring
    raw messages are never lost or corrupted in /feed.
    """
    try:
